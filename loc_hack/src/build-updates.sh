...
./kindletool create ota2 -d kindle4 install.sh bcel-5.2.jar K3Translator.jar translation.jar default.keyb bg.properties low_level_screens.tar.gz img.tar.gz updatewait MobiReader-bg_BG.jar Update_${ARCH}_nff_lp_install.bin
...
./kindletool create ota2 -d kindle4 install.sh bcel-5.2.jar K3Translator.jar translation_nlp.jar default.keyb bg.properties updatewait MobiReader-bg_BG.jar framework-api-bg_BG.jar Update_${ARCH}_ff_nlp_install.bin

# Build install update witout font-fix & witout langpack (keyboard only)
cp -f install_nff_nlp.sh install.sh
./kindletool create ota2 -d kindle4 install.sh bcel-5.2.jar K3Translator.jar translation_nlp.jar default.keyb bg.properties updatewait Update_${ARCH}_nff_nlp_install.bin
